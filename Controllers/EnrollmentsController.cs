...
namespace UniversityEnrollment.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(UniversityEnrollmentContext context)
        {
            _context = context;
        }
        ...
        {
            var universityEnrollmentContext = _context.Enrollment.Include(e => e.course).Include(e => e.student);
            return View(await universityEnrollmentContext.ToListAsync());
        }
