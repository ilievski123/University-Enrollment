...
namespace UniversityEnrollment.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(UniversityEnrollmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string title, int semester, string programme)
        {
            ...
            var CourseFilter = new FilterCourses
            {
                ...
                try
                {
                    ...
                    if (selectedStudents != null)
                    {
                        ...
                        foreach (int studentId in newEnrollments)
                            _context.Enrollment.Add(new Enrollment { studentId = studentId, courseId = id, year = viewmodel.year });
        ...
        public async Task<IActionResult> CoursesTeaching(int? id)
        {
            ...
            var CourseTitle = new FilterCourses
            {
